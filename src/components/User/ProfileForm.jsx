    ...
    <form onSubmit={formSubmit}>
      <div className="row h-100">
        <div className="col-md-12 col-lg-12 col-sm-12 col-12 ">
          <div className="card container animated fadeIn p-5  bg-dark gradient-bg">
            <h5 className="mb-3">Profile</h5>

            <div className="row">
              <div className="col-md-4 col-lg-4 col-sm-12 p-2 col-12">
                <p className="form-label text-light">User Image</p>
                <input
                  value={data.user_img}
                  onChange={(e) => {
                    inputOnChange("user_img", e.target.value);
                  }}
                  type="text"
              ...
              <div className="col-md-4 col-lg-4 col-sm-12 p-2 col-12">
                <p className="form-label text-light">First Name</p>
                <input
              ...
              <div className="col-md-4 col-lg-4 col-sm-12 p-2 col-12">
                <p className="form-label text-light">Last Name</p>
                <input
                  value={data.lastName}
                  onChange={(e) => {
              ...
              <div className="col-md-4 col-lg-4 col-sm-12 p-2 col-12">
                <p className="form-label text-light">Mobile</p>
                <input
                  value={data.mobile}
                  onChange={(e) => {
