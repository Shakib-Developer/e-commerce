  ...
  const addToCart = (event, product) => {
    ...
    setCartProducts((prevCart) => {
      ...
      if (existingProduct) {
        ...
        setCartPopupOpen(true); // Set isCartPopupOpen to true when adding the first product
        return newCart;
      }
    });
  };
    ...
    <div>
      <div className="main-section">
        <div className="row main-container justify-content-start align-items-normal flex-wrap flex-direction-row d-flex">
          <div className="search-row-container">
            <div className="search-row">
              <div className="row justify-content-start align-items-normal flex-wrap flex-direction-row d-flex">
                <div className="col-sm-12 d-flex gap-5 d-block">
                  <div className="col-sm-6 col-lg-3  d-block">
                    <div>
                      <button className="btn default small gtm-location-selector category-button">
                        <div className="title-icon medium">
                  ...
                  <div className="col-sm-6 col-lg-9  d-block">
                    <div>
                                ...
                                >
                                  <div className="container-2">
                                    ...
                                    <div className="contents">
                                      ...
                                      <div>
                                        <p className="membership fw-bold">
                                          {item["type"]}
                                        </p>
                                        ...
                                        <div className="d-flex gap-3 align-items-center">
                                          <button
                                            ...
                                            className="btn mt-2 btn-sm text-left btn-outline-danger"
                                          >
                                            Add Cart
                                          </button>
                                          ...
                                          <Link
                                            ...
                                            className="btn mt-2 btn-sm text-left btn-outline-success"
                                          >
                                            Buy Now
                                          </Link>
                                        </div>
          ...
          <div className="col-sm-12 col-lg-3 d-block">
            {/* Cart icon */}
            <div
              className="cart-icon text-end fs-6"
              onClick={() => setCartPopupOpen(!isCartPopupOpen)}
            >
              <FaShoppingCart />
              <span className="text-danger ms-1 fw-bold">{totalQuantity}</span>
            </div>
