  ...
  return (
    <Fragment>
      <div
        ...
        className="side-nav-open bg-info"
      >
        <h3 className="side-nav-logo fw-bold">
        ...
        >
          ...
          <span className="mx-2 side-bar-item-caption">My Profile</span>
        </Link>
        ...
        >
          <img className="w-8" src="/images/person-bounding-box.svg" />
          <span className="mx-2 side-bar-item-caption">Category</span>
        </Link>
        ...
        >
          <img className="w-8" src="/images/person-bounding-box.svg" />
          <span className="mx-2 side-bar-item-caption">Products</span>
        </Link>
        ...
        >
          <img className="w-8" src="/images/person-bounding-box.svg" />
          <span className="mx-2 side-bar-item-caption">Update Profile</span>
        </Link>
      </div>
